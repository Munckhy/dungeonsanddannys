  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
       ...
       <fieldset>
          <legend><?php echo $entry_responsive; ?></legend>
         <div class="form-group">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><?php echo $entry_responsive; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
             <select name="config_responsive" class="form-control">
                <?php if ($config_responsive == 1) { ?>
