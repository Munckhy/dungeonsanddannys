  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
       ...
       <?php if ($layout_module['position'] == 'promobanner') { ?>
       <option value="promobanner" selected="selected"><?php echo $text_promobanner; ?></option>
       <?php } else { ?>
       <option value="promobanner"><?php echo $text_promobanner; ?></option>
       <?php } ?>
...
function addModule() {
    ...
    html += '    <option value="content_top"><?php echo $text_content_top; ?></option>';
       ...
       html += '    <option value="promobanner"><?php echo $text_promobanner; ?></option>';
