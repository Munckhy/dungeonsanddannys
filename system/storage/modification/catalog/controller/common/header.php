...
class ControllerCommonHeader extends Controller {
	public function index() {
       ...
       $data['navigation'] = $this->load->controller('common/navigation');
        ...
        $data['promobanner'] = $this->load->controller('common/promobanner');
       ...
       $data['responsive'] = $this->config->get('config_responsive');
       ...
       $data['theme_path'] = $this->config->get($this->config->get('config_theme') . '_directory');
		...
		$data['text_category'] = $this->language->get('text_category');
				...
				$data['logo_desc'] = $this->language->get('logo_desc');
				$data['login_form_title'] = $this->language->get('login_form_title');
				$data['login_form'] = $this->load->controller('module/tm_header_login');
