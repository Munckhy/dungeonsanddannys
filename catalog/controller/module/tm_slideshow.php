...
class ControllerModuleTmSlideshow extends Controller {
	public function index($setting) {
		...
		$this->document->addScript('catalog/view/theme/' . $this->config->get($this->config->get('config_theme') . '_directory') . '/js/swiper/swiper.min.js');
		...
		if (isset($setting['slides'])) {
			...
			if ($vid) {
				$this->document->addScript('catalog/view/theme/' . $this->config->get($this->config->get('config_theme') . '_directory') . '/js/swiper/jquery.vide.min.js');
			}
		}
