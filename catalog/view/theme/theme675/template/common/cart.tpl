		...
		<ul class="pull-right toggle_cont">
			...
			<li>
				...
				<div class="text-right">
					<a class="cart-remove-btn btn material-design-visibility1" href="<?php echo $cart; ?>"><span> <?php echo $text_cart; ?></span></a>
					<a class="cart-remove-btn btn material-design-forward18" href="<?php echo $checkout; ?>"><span ><?php echo $text_checkout; ?></span></a>
				</div>
			</li>
			<?php } else { ?>
			<li>
