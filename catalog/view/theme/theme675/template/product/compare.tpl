			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td class="text-center">
								<div class="product-thumb">
									<a href="<?php echo $product['remove']; ?>" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="cart-remove-btn material-design-rubbish"></a>
						...
						<tr>
							...
							<td><?php echo $products[$product['product_id']]['length']; ?>
								...
								x <?php echo $products[$product['product_id']]['height']; ?>
							</td>
							<?php } ?>
						</tr>
					</tbody>
					...
					<tr>
						...
						<?php foreach ($products as $product) { ?>
						<td class="text-center">
							<button type="button" class="product-btn-add" data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');">
